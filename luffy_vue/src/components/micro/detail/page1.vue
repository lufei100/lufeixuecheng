<template>
  <div>
    <div>
      ...
      <div class="tab-menu">
        <div>
          <a v-on:click="changeTab('detail')">基本信息</a>

        </div>        <div>
          <a v-on:click="changeTab('detail')">课程</a>

        </div>        <div>
          <a v-on:click="changeTab('detail')">我们的服务</a>

        </div>        <div>
          <a v-on:click="changeTab('detail')">师资力量</a>

        </div>        <div>
          <a v-on:click="changeTab('detail')">学员评价</a>

        </div>
        <div>
          <a v-on:click="changeTab('detail')">常见问题</a>
...
<script>
  export default {
    data() {
      return {
        courseId: this.$route.params.id, // 获取url中传递的当前的课程id
        title: null,
